...
{
    private static readonly SkillTable instance = new SkillTable();
    public static SkillTable Instance => instance;

    public readonly Dictionary<int, Skill> SkillDataDic = new Dictionary<int, Skill>()
    {
        {
        ...
        },
        {
            2, new Skill(2, "번개", new Dictionary<StatType, Stat>()
                ...
                (skill) => $"무작위 적 {skill.TargetCount}명에게 공격력 * {skill.Stats[StatType.Attack].FinalValue} 피해를 줍니다")
        }
    };
}